...
for "_i" from 1 to 4 do
	{
	_grupo = if (_dificil) then {[_posicion,malos, cfgNATOInf >> gruposNATOSentry] call BIS_Fnc_spawnGroup} else {[_posicion,malos, (configfile >> "CfgGroups" >> "West" >> "Gendarmerie" >> "Infantry" >> "GENDARME_Inf_Patrol")] call BIS_Fnc_spawnGroup};
	sleep 1;
