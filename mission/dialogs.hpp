...
class HQ_button_Gsquad: RscButton
{
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "if (player == Stavros) then {if (distanciaSPWN < 2000) then {distanciaSPWN = distanciaSPWN + 100; if (distanciaSPWN > 2000) then {distanciaSPWN = 2000};publicVariable ""distanciaSPWN"";}; hint format [""Spawn Distance Set to %1 meters. Be careful, this may affect game performance"",distanciaSPWN]} else {hint ""Only Player Commander has access to this function""};";
};
class HQ_button_Gstatic: RscButton
{
	idc = -1;
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "if (player == Stavros) then {if (distanciaSPWN > 600) then {distanciaSPWN = distanciaSPWN - 100; if (distanciaSPWN < 600) then {distanciaSPWN = 600};publicVariable ""distanciaSPWN"";}; hint format [""Spawn Distance Set to %1 meters"",distanciaSPWN]} else {hint ""Only Player Commander has access to this function""};";
};
////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT END
////////////////////////////////////////////////////////
...
class HQ_button_Gsquad: RscButton
{
	...
	w = 0.175015 * safezoneW;
	h = 0.0560125 * safezoneH;
	action = "closeDialog 0;nul = [""C_Offroad_02_unarmed_F""] call addFIAveh;";
};
class HQ_button_Gstatic: RscButton
{
	idc = 105;
