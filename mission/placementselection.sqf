if (!isNil "placementDone") then
	...
	"Petros is Dead" hintC "Maru has been killed. You lost part of your assets and need to select a new HQ position far from the enemies.";
	}
else
	{
...
if (visiblemap) then
	...
	if (isNil "placementDone") then
        ...
        petros = grupoPetros createUnit ["I_C_Soldier_Camo_F", _posicionTel, [], 0, "NONE"];
